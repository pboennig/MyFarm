public class OptimalValuesCalculator {
    ...
    private double nFertilizerContent;

    public static void main(String... args) {
        OptimalValuesCalculator myCalc = new OptimalValuesCalculator(5.0, Crop.CORN, .72);
    ...
    public double getFertilizerAmount() {
        return this.crop.getOptimalFertilizer() / this.nFertilizerContent / 100000; // to account for m^2 to hectares, in kg
    }
